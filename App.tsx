...
const App: React.FC = () => {
  ...
  useEffect(() => {
    // Check if the app is using the placeholder PayPal Client ID.
    const placeholderId = 'AT6GwV2NXHr38tEW6E7-CrFUa1ITWHlPKL8NFMP8m8o7iJpOEgiN_jZfPNm7Ja8ZLND1bnJ_9uwgk4Ne';
    const script = document.querySelector(`script[src*="client-id=${placeholderId}"]`);
    if (script) {
        setIsDevMode(true);
    }
  }, []);
  ...
  const executeImageEdit = async (cost: number, fullPrompt: string) => {
    ...
    try {
      ...
      setHistory(prev => [newHistoryItem, ...prev].slice(0, isProUser ? 50 : 10));
  ...
  return (
    <div className="min-h-screen bg-black text-slate-200 font-sans flex flex-col">
      ...
      />
      {isDevMode && (
        <div className="bg-yellow-500 text-black text-center p-2 text-sm font-semibold sticky top-[69px] z-40">
          <div className="container mx-auto flex items-center justify-center gap-3">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
              <path fillRule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.21 3.03-1.742 3.03H4.42c-1.532 0-2.492-1.696-1.742-3.03l5.58-9.92zM10 13a1 1 0 110-2 1 1 0 010 2zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
            </svg>
            <span><strong>DEV MODE:</strong> Payments are sandboxed. Replace the placeholder PayPal Client ID in <strong>index.html</strong> to go live.</span>
          </div>
        </div>
      )}
                ...
                {paymentStatus === 'idle' && (
                    ...
                    {purchaseModalTab === 'pro' && (
                      <div className="flex flex-col items-center gap-4 p-4 bg-yellow-900/20 border border-yellow-500/30 rounded-lg">
                          ...
                          <div className="text-left space-y-4 my-2 w-full">
                              <div>
                                  <h4 className="font-semibold text-cyan-300 mb-2">Available Now:</h4>
                                  <ul className="space-y-2 text-slate-300">
                                      <li className="flex items-start gap-3">
                                          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-green-400 flex-shrink-0 mt-0.5" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" /></svg>
                                          <span><b>Unlimited AI Edits</b> (No credit costs)</span>
                                      </li>
                                      <li className="flex items-start gap-3">
                                          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-green-400 flex-shrink-0 mt-0.5" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" /></svg>
                                          <span><b>Expanded History</b> (Saves up to 50 creations to your device)</span>
                                      </li>
                                  </ul>
                              </div>
                              <div>
                                  <h4 className="font-semibold text-slate-500 mb-2">Coming Soon:</h4>
                                  <ul className="space-y-2 text-slate-400">
                                      <li className="flex items-start gap-3">
                                          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-slate-500 flex-shrink-0 mt-0.5" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.414-1.415L11 9.586V6z" clipRule="evenodd" /></svg>
                                          <span>Permanent Cloud History Backup</span>
                                      </li>
                                      <li className="flex items-start gap-3">
                                          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-slate-500 flex-shrink-0 mt-0.5" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.414-1.415L11 9.586V6z" clipRule="evenodd" /></svg>
